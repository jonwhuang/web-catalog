...
20.times do
  new_product = Product.new(title: Faker::Commerce.product_name, description: Faker::Hacker.say_something_smart, price: Faker::Commerce.price, picture_link: Faker::Avatar.image(Faker::Name.first_name, "150x150"), quantity: rand(0..20))
