...
new_product.categories << Category.find(2) << Category.find(4) << Category.find(9) << Category.find(10)
new_product.save
...
new_product.categories << Category.find(2) << Category.find(5) << Category.find(6) << Category.find(9)
new_product.save
...
new_product.categories << Category.find(3) << Category.find(8)
new_product.save
